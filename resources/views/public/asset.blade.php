...
@section('content')
    <article class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <header class="flex flex-col gap-5 p-5 sm:flex-row sm:items-center sm:p-8">
            <span class="grid size-16 shrink-0 place-items-center rounded-xl bg-blue-50 text-xl font-bold text-blue-600 sm:size-24 sm:text-3xl">
